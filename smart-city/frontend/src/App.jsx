...
import { Building2, PlusCircle, Search, LayoutDashboard, Heart } from 'lucide-react';
...
function App() {
  return (
    <Router>
      <div className="min-h-screen bg-gray-900 text-gray-100 antialiased selection:bg-blue-500/30 selection:text-blue-200 overflow-x-hidden">

        {/* Global ambient background glows */}
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-15%] left-[-10%] w-[50%] h-[50%] rounded-full bg-blue-900/15 blur-[160px]" />
          <div className="absolute bottom-[-15%] right-[-10%] w-[45%] h-[45%] rounded-full bg-emerald-900/10 blur-[160px]" />
          <div className="absolute top-[40%] right-[20%] w-[20%] h-[20%] rounded-full bg-purple-900/8 blur-[100px]" />
        </div>
